    ...
    const fetchSavedItems = async () => {
      ...
      try {
        ...
        const { data, error } = await supabase
          .from("listings")
          .select("id, title, description, price, category, condition, seller_id, college, created_at, sold, likes, images")
          .in("id", listingIds)
          .eq("sold", false)
...
export default CartPageCompact;
