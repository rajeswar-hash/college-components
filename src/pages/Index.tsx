        ...
        {!selectedCollege ? (
          <div className="animate-fade-in">
            <div className="relative -mx-4 overflow-hidden px-0 py-4 sm:mx-0">
              ...
              <div className="pointer-events-none absolute inset-x-0 top-0 bottom-0 bg-[linear-gradient(180deg,rgba(240,253,255,0.08),rgba(255,255,255,0.05)_30%,rgba(255,255,255,0.42)_62%,rgba(255,255,255,0.94)_82%,rgb(255,255,255)_100%)]" />
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-36 bg-[linear-gradient(180deg,rgba(255,255,255,0)_0%,rgba(255,255,255,0.62)_34%,rgba(255,255,255,0.92)_68%,rgb(255,255,255)_100%)]" />
